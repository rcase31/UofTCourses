...
public class Main {
    ...
    public static void main(final String[] args) 
        ...
        iterator.AddressBook book = new iterator.AddressBook();
        readBook(book);
        ...
        System.out.println(String.format("C1: %s, %s", contacts1.hasNext(),
                contacts1.next()));
        System.out.println(String.format("C1: %s, %s", contacts2.hasNext(),
                contacts2.next()));
        System.out.println(String.format("C2: %s, %s", contacts2.hasNext(),
                contacts2.next()));
        System.out.println(String.format("C3: %s, %s", contacts2.hasNext(),
                contacts2.next()));

        System.out.println(String.format("C2: %s, %s", contacts1.hasNext(),
                contacts1.next()));
        System.out.println(String.format("C4: %s, %s", contacts2.hasNext(),
                contacts2.next()));
    }
